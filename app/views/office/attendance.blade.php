				    ...
				    <table class="table">
				        ...
				        <tbody>
				            ...
				            <tr>
								...
								<td>
									@if($student['ticket'])
								        <input type="checkbox" name="attendanceList[]" value="{{$student['username']}}">
							        @else
								        <input type="checkbox" name="attendanceList[]" value="{{$student['username']}}" disabled>
							        @endif
				                </td>
				            </tr>
				            @endforeach
